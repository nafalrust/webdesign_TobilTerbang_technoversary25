...
const ContactPage = () => {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-12 min-h-[70vh] flex items-center">
      <Card className="p-8 w-full relative overflow-hidden bg-[#F2F9F5]/90 dark:bg-[#0B1410]/90">
        ...
        <div className="relative z-10">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#0B1410] dark:text-white mb-2">
              Hubungi Markas
            </h2>
          ...
          {sent ? (
            <div className="text-center py-12 animate-bounce-in">
              ...
              <h3 className="text-2xl font-bold text-[#0B1410] dark:text-white mb-2">
                Transmisi Diterima!
              </h3>
              <p className="text-slate-500 dark:text-[#A0C4A8]">
            ...
            >
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-[#A0C4A8] mb-2">
                  Codename
                </label>
                <input
                  required
                  type="text"
                  className="w-full px-4 py-3 rounded-xl bg-white/50 dark:bg-[#020604]/50 border border-slate-200 dark:border-[#2E5C35] focus:ring-2 focus:ring-[#45FF90] focus:border-[#45FF90] outline-none transition-all placeholder-slate-400 dark:text-white"
